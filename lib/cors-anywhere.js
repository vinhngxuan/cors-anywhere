...
function withCORS(headers, request) {
  ...
  // for sites use Authorization token and will need preflight request
  // which not access-control-allow-origin * is not allowed
  headers['access-control-allow-origin'] = process.env.FRONT_END_URL;
